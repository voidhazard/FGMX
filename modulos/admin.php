...
if(isset($enviar)){
	...
	$q = $mysqli->query("SELECT * FROM Administrador WHERE usuario = '$username' AND password = '$password'");
...
if(isset($_SESSION['id_admin'])){ // si hay una sesion iniciada
	?>
	<a href="?p=agregar_producto">
		...
		<a href="?p=manejo_reporte">
		<button class="btn btn-warning"><i class="fa fa-plus-circle"></i> Reporte ventas</button></a>
	<?php
