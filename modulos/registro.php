...
if(isset($enviar)){
	...
	$nombre = clear($nombre);
	$q = $mysqli->query("SELECT * FROM Clientes WHERE usuario = '$username'");
	...
	$mysqli->query("INSERT INTO Clientes (usuario,password,nombre) VALUES ('$username','$password','$nombre')");
	
	
	$q2 = $mysqli->query("SELECT * FROM Clientes WHERE usuario = '$username'");
