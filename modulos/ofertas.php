...
if(isset($cat)){
	$q = $mysqli->query("SELECT * FROM Producto WHERE id_categoria = '$cat' AND oferta>0 ORDER BY clave DESC");
}else{
	$q = $mysqli->query("SELECT * FROM Producto WHERE oferta>0 ORDER BY clave DESC");}
